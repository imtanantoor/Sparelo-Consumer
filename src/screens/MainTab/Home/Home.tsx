...
function Home({ navigation }: NativeStackScreenProps<any>): JSX.Element {
  ...
  return <SafeAreaView style={styles.container}>
    ...
    <ScrollView
      ...
      <AdsSlider
        data={[
          { imageUrl: 'https://images.unsplash.com/photo-1553440569-bcc63803a83d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1725&q=80' },
          { imageUrl: 'https://images.unsplash.com/photo-1553440569-bcc63803a83d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1725&q=80' },
        ]} />
    </ScrollView>
  </SafeAreaView>
